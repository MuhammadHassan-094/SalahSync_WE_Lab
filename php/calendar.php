...
<head>
    ...
    <title>Islamic Calendar - SalahSync</title>
    ...
    <div class="container mt-4">
        <div class="card">
            <div class="card-header">
                <h3><i class="fas fa-calendar-alt me-2"></i>Islamic Calendar</h3>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="islamic-date mb-4">
                            <h4>Today's Islamic Date</h4>
                            <div id="hijri-date" class="mt-3 fs-3">
                    ...
                    <div class="col-md-6">
                        <div class="upcoming-events">
                            <h4><i class="fas fa-star me-2"></i>Upcoming Islamic Events</h4>
                            <ul id="events-list" class="mt-3">
                                <li><i class="fas fa-spinner fa-spin"></i> Loading events...</li>
                            </ul>
                        </div>
                    </div>
                </div>
