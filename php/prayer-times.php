...
<head>
    ...
    <title>Prayer Times - SalahSync</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link active" href="prayer-times.php">
    ...
    <div class="container mt-4">
        <div class="card">
            <div class="card-header">
                <h3><i class="fas fa-clock me-2"></i>Prayer Times</h3>
            </div>
            <div class="card-body">
                ...
                <div class="prayer-times-grid">
                    <!-- Prayer Time Cards will be dynamically added here -->
                    <div class="prayer-time-card">
                        <div class="prayer-icon">
                            <i class="fas fa-sun"></i>
                        </div>
                        <h6>Fajr</h6>
                        <p class="time" id="fajr"><i class="fas fa-spinner fa-spin"></i></p>
                    </div>
                    <div class="prayer-time-card">
                        <div class="prayer-icon">
                            <i class="fas fa-sun"></i>
                        ...
                        <h6>Dhuhr</h6>
                        <p class="time" id="dhuhr"><i class="fas fa-spinner fa-spin"></i></p>
                    </div>
                    <div class="prayer-time-card">
                        <div class="prayer-icon">
                            <i class="fas fa-sun"></i>
                        ...
                        <h6>Asr</h6>
                        <p class="time" id="asr"><i class="fas fa-spinner fa-spin"></i></p>
                    </div>
                    <div class="prayer-time-card">
                        <div class="prayer-icon">
                        ...
                        <h6>Maghrib</h6>
                        <p class="time" id="maghrib"><i class="fas fa-spinner fa-spin"></i></p>
                    </div>
                    <div class="prayer-time-card">
                        <div class="prayer-icon">
                            <i class="fas fa-moon"></i>
                        ...
                        <h6>Isha</h6>
                        <p class="time" id="isha"><i class="fas fa-spinner fa-spin"></i></p>
                    </div>
                </div>
            </div>
        </div>
